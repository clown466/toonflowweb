...
| ---------------------------------------------- | -------------- | -------------------------------------------------------- | ------------------------------------------------------- |
| 🎬 **普通用户** - 想直接使用 Toonflow 创作短剧 | 下载完整客户端 | [Toonflow-app](https://github.com/clown466/toonflowback) | [Toonflow-app](https://github.com/clown466/toonflowback) |
...
- ✅ **后端服务**：确保 Toonflow 后端服务已启动并可访问（可从 [GitHub](https://github.com/clown466/toonflowback) 或 [Gitee](https://github.com/clown466/toonflowback) 获取）
...
> 💡 **提示**：后端服务可从 [GitHub](https://github.com/clown466/toonflowback) 或 [Gitee](https://github.com/clown466/toonflowback) 仓库获取。
...
| 仓库             | 说明                             | GitHub                                             | Gitee                                            |
| ---------------- | -------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **Toonflow-app** | 完整客户端（推荐普通用户）       | [GitHub](https://github.com/clown466/toonflowback) | [Gitee](https://github.com/clown466/toonflowback) |
| **Toonflow-web** | 前端源代码（本仓库，适合开发者） | [GitHub](https://github.com/clown466/toonflowweb) | [Gitee](https://github.com/clown466/toonflowweb) |
